$(document).ready(function () {
    ...
    $("#btnGrabarDatos").click(function () {
        $.ajax({
            ...
            type: "POST",
            data: {
                _IdTipoContenedorOrigen: $("#CantidadPMachos").val(),
                _FechaRegistro: $(single_cal1).val(),
                _IdFactoresMedicion: $("#CantidadPHembra").val(),
                _CantidadOrigen: $("#NroDesoveTemporada").val(),
                _CalibreOrigen: $("#CantFecundada").val(),
                _IdTipoContenedorDestino: $("#CantSembrada").val()
            },
